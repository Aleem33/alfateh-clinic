...
import { collection, onSnapshot, updateDoc, doc, writeBatch, query, orderBy, limit } from '@/lib/firestore';
...
// Extract display name from internal email: "dr.ahmed@alfateh-clinic.internal" → "dr.ahmed"
